...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("live-excel", id="custom-output"),
    ],
)
def test_live_convert_to_excel_success(
    pdfrest_api_key: str,
    pdfrest_live_base_url: str,
    ...
    with PdfRestClient(
        ...
        response = client.convert_to_excel(uploaded_pdf_for_excel, **kwargs)
...
def test_live_convert_to_excel_invalid_file_id(
    pdfrest_api_key: str,
    pdfrest_live_base_url: str,
    uploaded_pdf_for_excel: PdfRestFile,
) -> None:
...
@pytest.mark.asyncio
async def test_live_async_convert_to_excel_invalid_file_id(
    pdfrest_api_key: str,
    pdfrest_live_base_url: str,
    uploaded_pdf_for_excel: PdfRestFile,
) -> None:
